...
function ImgContainer({ characters, buttonHandler, markerData, clicker }) {
  return (
    <div className={styles['universe-container']} onClick={clicker} data-img-container id="img-container">
